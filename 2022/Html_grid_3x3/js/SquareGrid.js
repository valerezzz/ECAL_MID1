...
class SquareGrid {
  ...
  onResize(e) {
    ...
    const w = window.innerHeight / this.grid.cols;
    this.offsetX = (window.innerWidth - window.innerHeight) / 2;
  ...
  initGrid() {
    ...
    // wrapper.style.width = wrapper.style.height = window.innerHeight;
